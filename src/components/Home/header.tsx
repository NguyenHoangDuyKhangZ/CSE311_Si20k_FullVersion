...
export default function Header() {
  ...
  // Dùng 1 state duy nhất để điều khiển menu mobile
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  // State điều khiển dropdown danh mục sản phẩm trên mobile
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md shadow-sm">
      ...
      {/* 4. Navigation Menu (Mobile) - Absolute positioning to overlay content */}
      <div 
      ...
      >
        <nav className="px-6 py-4 flex flex-col gap-4 font-medium text-gray-700">
          ...
          <div>
            ...
            >
              Products <i className={`fas fa-chevron-${isProductsDropdownOpen ? 'up' : 'down'} text-sm`}></i>
            </button>
            
            {/* Sub-menu hiển thị khi bấm vào Products */}
