      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
        ...
        {!showAddForm && (
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 sm:py-3 rounded-lg transition-colors flex items-center justify-center sm:justify-start gap-2 text-sm sm:text-base"
          >
                    ...
                    <div className="flex-grow min-w-0">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-3 sm:mb-4">
                        <div className="bg-gray-50 dark:bg-gray-700 p-2 sm:p-3 rounded-lg">
                          ...
                          <p className="text-sm sm:text-base font-bold text-indigo-600 break-words">
                        ...
                        {product.originalPrice && (
                          <div className="bg-gray-50 dark:bg-gray-700 p-2 sm:p-3 rounded-lg">
                            ...
                            <p className="text-xs sm:text-sm line-through text-gray-500">
                              {(product.originalPrice / 1000).toFixed(0)}k đ
                            </p>
                          </div>
                        )}
                        <div className="bg-gray-50 dark:bg-gray-700 p-2 sm:p-3 rounded-lg">
